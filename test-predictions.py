...
# This script allows users to input car details and get price predictions
...
#             # Load cleaned data to get feature options
#             print("\n5️⃣ Loading feature options...")
...
#             while True:
#                 user_input = input(f"\n   Enter {feature.replace('_', ' ').title()}: ").strip().lower()
...
#                     break
#                 else:
#                     print(f"   ❌ Invalid input! Please choose from available options.")
                    
#                     # Show first 5 options as a reminder
#                     print(f"   Examples: {', '.join(map(str, self.feature_options[feature][:5]))}")
...
#         """Predict car price based on input details"""
#         try:
...
#                     encoded_value = self.label_encoders[cat_feat].transform(
#                         [car_details[cat_feat]]
#                     )[0]
#                     feature_vector.append(encoded_value)
#                 except ValueError:
#                     # If value not seen during training, use mode (most common)
#                     print(f"   ⚠️  Warning: '{car_details[cat_feat]}' not seen in training for {cat_feat}")
#                     print(f"      Using default encoding...")
#                     encoded_value = 0  # Use first class as default
#                     feature_vector.append(encoded_value)
            
#             # Add numerical features
#             for num_feat in self.feature_info['numerical_features']:
#                 feature_vector.append(car_details[num_feat])
...
#     def display_prediction(self, car_details, predicted_price, 
...
#                 elif 'fuel_average' in key.lower():
#                     print(f"   • {display_name}: {value:.1f} km/l")
#                 else:
...
#                         print("="*70)
#                         print("\n💡 Tip: You can run this script anytime to make more predictions!")
#                         print("\n" + "="*70)
#                         break
#                 else:
...
#         return partial_matches[:20]  # Limit to 20 results
...
#                         print(f"   💡 Try simpler terms like: 'civic', 'city', 'corolla', etc.")
...
# """
# Interactive Prediction System for Car Price Prediction
# With Flexible City Input - Accept any Pakistan city!
# """
...
#         # 🆕 City mapping - Map any Pakistan city to nearest major city
#         self.city_mapping = {
#             # Karachi region
#             'karachi': 'karachi',
#             'hyderabad': 'karachi',
...
#             for feature in self.feature_info['numerical_features']:
#                 # For engine, add common sizes manually
#                 if feature == 'engine':
...
#         car_details = {}
#         city_info = {}  # Store city mapping info
...
#             if feature == 'city':
#                 print(f"\n   🌍 Enter your city:")
#                 print(f"   💡 You can enter any Pakistan city (e.g., Multan, Faisalabad, Peshawar)")
#                 print(f"   📍 Common cities: Karachi, Lahore, Islamabad, Rawalpindi, Multan, etc.")
                
#                 while True:
#                     user_city = input(f"\n   Enter City: ").strip()
                    
#                     if user_city:
#                         # Map to training city
...
#                         if was_mapped:
#                             print(f"   ✓ City: {original_city.title()} (using {mapped_city.title()} pricing)")
#                         else:
...
#         # Add city info to car_details for display purposes
...
# """
# Interactive Prediction System for Car Price Prediction
# FIXED: Now supports Polynomial Features
# """
...
#         self.model_info = {}
#         self.feature_options = {}
#         self.poly = None  # ✅ NEW: Polynomial transformer
#         self.kmeans = None  # ✅ NEW: K-Means model
#         self.cluster_scaler = None  # ✅ NEW: Cluster scaler
...
#             # ✅ NEW: Load Polynomial transformer
...
#                 print(f"   ⚠️ Polynomial transformer not found (using original features)")
#                 self.poly = None
            
#             # ✅ NEW: Load K-Means model
...
#     def predict_price(self, car_details):
#         """✅ FIXED: Predict car price with Polynomial Features support"""
#         try:
#             # Create feature vector
#             feature_vector = []
...
#             # ✅ NEW: Apply Polynomial Features if available
#             if self.poly is not None:
#                 # Transform numerical features to polynomial
...
#                 # Combine categorical encoded + polynomial features
...
# """
# Interactive Prediction System for Car Price Prediction
# FIXED: Now supports Polynomial Features + 80+ Pakistan Cities
# """
...
#     def predict_price(self, car_details):
#         """Predict car price with Polynomial Features support"""
#         try:
#             feature_vector = []
...
#             if self.kmeans is not None and self.cluster_scaler is not None:
#                 cluster_input = np.array([[predicted_price, car_details['registered_in'], car_details['mileage']]])
#                 cluster_scaled = self.cluster_scaler.transform(cluster_input)
#                 cluster_id = self.kmeans.predict(cluster_scaled)[0]
